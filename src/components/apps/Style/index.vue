...
const maxWidthInput = computed({
  get: () => String(panelState.panelConfig.maxWidth || ''),
  set: (val) => {
    panelState.panelConfig.maxWidth = Number(val) || undefined
  }
})
      ...
      <NGrid cols="2">
        ...
        <NGridItem span="12 400:12">
          <div class="flex items-center mt-[10px]">
            ...
            <div class="flex">
              <NInputGroup>
                <NInput v-model:value="maxWidthInput" size="small" type="text" :maxlength="10" :style="{ width: '100px' }" placeholder="1200" />
